...
class T_UNet(BaseNetwork):
    ...
    def __init__(self,
        ...
        # image_size from kwargs (config.target_dim[0]); guided_diffusion UNet supports
        # only {64,128,256,512}. The 620 GA-protecting crop happens in the dataset; the
        # image is resized to this model size before the UNet.
